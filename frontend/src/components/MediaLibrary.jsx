    ...
    <section id="media" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {mockData.mediaResources.map((resource) => {
        ...
        <div className="mt-16 bg-gradient-to-br from-blue-900 to-blue-700 rounded-3xl overflow-hidden shadow-2xl">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-12 flex flex-col justify-center text-white">
              ...
              <h3 className="text-3xl font-bold mb-4">Bharat Jodo Yatra Documentary</h3>
              <p className="text-lg text-blue-100 mb-6 leading-relaxed">
                Experience the 4,000 km journey of unity, hope, and transformation. A complete visual chronicle of India's largest people's movement.
              </p>
              <Button
                size="lg"
